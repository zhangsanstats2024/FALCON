...
class IHTGroupPruner:
    ...
    device,algo='MP', alpha_scale=1, prune_type="channel"):
        '''
    ...
    def prune_group(self,mask,sparsity, grads=None):
        ...
        w_pruned, obj = group_pruner(y,grads,w1,k, alpha_vec, self.lambda2, beta_tilde2, self.model, self.params, self.block_list, self.algo, sol_opt, self.prune_type)
